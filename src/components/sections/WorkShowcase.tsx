...
export default function WorkShowcase() {
  return (
    <section
      id="work"
      className="border-b border-[#D9D1C7] bg-[#FFFDF8] py-20 md:py-28"
    >
      <Container>
        ...
        <div className="mt-14 grid gap-8">
          {featuredProjects.map((project, index) => (
            <article
              key={project.title}
              className="rounded-[36px] border border-[#D9D1C7] bg-[#FBF7F1] p-6 md:p-8"
            >
              <div
              ...
              >
                <div
                  className={`rounded-[30px] ${project.background} p-8 md:p-10 ${
                ...
                >
                  ...
                  <h3 className="mt-6 text-3xl font-semibold tracking-[-0.05em] text-[#181716] md:text-4xl">
                    {project.title}
                  </h3>
                ...
                >
                  <div
                    className={`rounded-[30px] ${project.accent} p-8 md:p-10 ${project.accentText}`}
                  >
                    <p className="text-xs font-medium uppercase tracking-[0.18em] text-inherit/80">
                      Visual Direction
                    </p>
                  ...
                  <div className="rounded-[30px] border border-[#D9D1C7] bg-[#FFFDF8] p-8 md:p-10">
                    <p className="text-xs font-medium uppercase tracking-[0.18em] text-[#6B645C]">
                      Build Focus
                    </p>

                    <div className="mt-6 grid gap-4 sm:grid-cols-3">
                      <div className="rounded-[22px] bg-[#F6F1E8] p-4">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {supportingProjects.map((project) => (
            <article
              key={project.title}
              className="flex h-full flex-col rounded-[28px] border border-[#D9D1C7] bg-[#FBF7F1] p-7 md:p-8"
            >
