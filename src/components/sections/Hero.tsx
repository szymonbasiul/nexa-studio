...
export default function Hero() {
	return (
		<section
			id="hero"
			className="relative overflow-hidden border-b border-[#D9D1C7] py-24 md:py-32"
		>
			<div className="pointer-events-none absolute inset-0 -z-10">
				<div className="absolute left-[-200px] top-[-100px] h-[400px] w-[400px] rounded-full bg-[#EADBC9] blur-[120px]" />
				<div className="absolute right-[-150px] top-[100px] h-[300px] w-[300px] rounded-full bg-[#F1E7DA] blur-[120px]" />
			</div>
